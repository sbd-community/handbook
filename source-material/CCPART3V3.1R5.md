...
Evaluation, version 3.1 _Parts 1 through 3 (called “CC_ 3.1 _”), they hereby grant non_ -
...
- April 2017 Version 3.1 Page 5 of Table of contents
...
- Page 6 of 247 Version 3.1 April Table of contents
...
- April 2017 Version 3.1 Page 7 of Table of contents
- 16 CLASS ATE: TESTS
...
- Page 8 of 247 Version 3.1 April Table of contents
- C CROSS REFERENCE OF ASSURANCE COMPONENT DEPENDENCIES
- D CROSS REFERENCE OF PPS AND ASSURANCE COMPONENTS
- E CROSS REFERENCE OF EALS AND ASSURANCE COMPONENTS
- F CROSS REFERENCE OF CAPS AND ASSURANCE COMPONENTS
- April 2017 Version 3.1 Page 9 of List of figures
- Figure 1 - Assurance class/family/component/element hierarchy List of figures
...
- Figure 9 - ACE: Protection Profile Configuration evaluation class decomposition
- Figure 10 - ASE: Security Target evaluation class decomposition
- Figure 11 - Relationships of ADV constructs to one another and to other families
...
- Figure 17 - Relationship between ACO families and interactions between components
...
- Page 10 of 247 Version 3.1 April List of tables
- Table 1 - Evaluation assurance level summary List of tables
- Table 2 - EAL1
- Table 3 - EAL2
- Table 4 - EAL3
- Table 5 - EAL4
...
176 Evaluating a PP-Configuration is required to demonstrate that the PP-
...
184 All content and presentation elements of APE_INT.1 hold with PP-Module
instead of PP.
...
ACE_INT.1.1E The evaluator shall confirm that the information provided meets all
requirements for content and presentation of evidence.
...
187 All content and presentation elements of APE_OBJ.2 hold.
...
```
ACE_MCO.1.1E The evaluator shall confirm that the information provided meets all
requirements for content and presentation of evidence. If the PP-Module
specifies alternate sets of Base-PPs, the evaluator shall perform this
...
ACE_CCO.1.1E The evaluator shall confirm that the information provided meets all
requirements for content and presentation of evidence.
...
ACE_CCO.1.2E The evaluator shall check that the PP-Configuration made up of all the
...
224 All portions of the TSF are security relevant, meaning that they must
...
the security relevance continuum is functionality termed SFR non-interfering.
...
241 Additional information on the security architecture properties of self-
...
non-interfering it must have no SFR-enforcing services or results. In contrast,
...
service may be only SFR-supporting). An example of a purely SFR-
...
251 The purpose of an interface is a high-level description of the general goal of
the interface (e.g. process GUI commands, receive network packets, provide
printer output, etc.)

252 The interface's method of use describes how the interface is supposed to be
...
253 Parameters are explicit inputs to and outputs from an interface that control
...
254 A parameter description tells what the parameter is in some meaningful way.
...
255 The description of an interface's actions describes what the interface does.
...
256 The error message description identifies the condition that generated it, what
...
262 At ADV_FSP.4 Complete functional specification, all TSFIs - whether SFR-
...
292 The term security policy has traditionally been associated with only access
...
296 This family uses two levels of decomposition: the subsystem and the module.
...
299 In the requirements for this family, the term interface is used as the means of
...
(ADV_FSP)). The term interaction is used to identify the purpose for
...
```
g) A description of interfaces provides the details of how the
...
306 The operational user guidance provides a measure of confidence that non-
...
458 The term interfaces refers to interfaces described in the functional
...
ACO_VUL.2.4E The evaluator shall perform an independent vulnerability analysis of the
...
533 Self-protection refers to the ability of the TSF to protect itself from
...
535 Domain separation is a property whereby the TSF creates separate security
...
540 The security architecture description presents the TSF's properties of self-
...
objects that are protected under the SFRs (e.g. FDP\_\* components) and
...
569 A Graphical User interface is similar: it translates between machine-
...
571 For a given TOE, not all of the interfaces may be accessible. That is, the
...
577 The interfaces labelled Bx represent interfaces to functionality in the IT
...
600 An SFR-enforcing subsystem is a subsystem that provides mechanisms for
...
601 Subsystems can also be identified as SFR-supporting and SFR-non-
...
615 In the elements below, the labels (SFR-enforcing, SFR-supporting, and SFR-
...
616 Because there is subjectivity in determining what is SFR-enforcing vs. SFR-
...
SFR Enforce (^) SupportSFR SFR NI (^) EnforceSFR SupportSFR SFR NI
ADV_TDS.1
Basic design
(informal
presentation)
...
additional formal
presentation)
(1) designation support means that only documentation sufficient to support the classification of the subsystem
/ module is needed.
(2) SFR interfaces means that the module description contains, for each SFR-related interface, the returned
values and the called interfaces to other modules.
(3) All interfaces means that the module description contains, for each interface, the returned values and the
...
620 A formal specification is expressed within a formal system based upon well-
...
(see e.g. http://vl.fmnet.info/b/ for further information).
```
...
```
b) Arrows coming out of 'base component-b' (C and D) = interfaces of
...
657 There are components a ('dependent component-a') and b ('base component-
