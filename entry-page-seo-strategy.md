...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| P1 | Medium rewrite | Homepage | `src/pages/index.tsx` | I need to understand secure by design for connected products and what to do next. | Route connected-product teams into obligations, readiness, implementation, and evidence. | Add four-path routing into obligations, readiness, implementation, and evidence. | Editorial + developer/site config | Needs edit | Not started |
| P1 | Major rewrite | What is Secure-by-Design? | `docs/quick-start/what-is-secure-by-design.md` | What does secure by design mean for connected-product teams? | Explain how secure by design changes product architecture, defaults, development, updates, vulnerability handling, and evidence. | Add P1 structure, process-change model, SbD vs secure-by-default distinction, checklist, and next-step routing. | Editorial + product-security reviewer | Needs rewrite | Not started |
| P1 | Light alignment | CRA Primer | `docs/quick-start/cra-primer.md` | What is the CRA and what does it mean for connected products? | Give a short, non-legal first read that routes readers into readiness or detailed reference. | Route more directly to CRA Readiness Gap Analysis and Evidence Pack. | Editorial + standards reviewer | Done | Not started |
| P1 | Ready | CRA Readiness Gap Analysis | `docs/resources/checklists-and-worksheets/cra-gap-analysis.md` | How do I assess CRA readiness and turn gaps into actions? | Produce a scoped readiness view, evidence map, gap register, and next actions. | Maintain; improve inbound links and grouped next-action routes if needed. | Editorial + standards reviewer + product-security reviewer | Done | Not started |
| P1 | Light alignment | Secure-by-Design Evidence Pack | `docs/resources/policy-and-evidence/audit-evidence-pack.md` | What evidence should we retain for secure-by-design and CRA technical documentation? | Give teams a lifecycle evidence structure for product security decisions and CRA technical documentation. | Standardise inbound anchor text and route from homepage and readiness pages. | Editorial + standards reviewer | Done | In progress |
| P1 | Medium rewrite | Secure Boot | `docs/implementation/build-phase/secure-boot.md` | What secure boot decisions and evidence matter for a CRA-scoped connected product? | Explain secure boot decisions, failure behavior, evidence, and related controls for connected products. | Add entry opening, good-state model, evidence section, common gaps, and grouped related links. | Editorial + technical reviewer + standards reviewer | Needs edit | Not started |
| P1 | Medium rewrite | OTA Updates and Patching | `docs/implementation/build-phase/ota-updates.md` | Can we safely deliver, verify, recover, and evidence security updates over the support period? | Explain the update architecture and lifecycle evidence needed to remediate vulnerabilities safely. | Add entry opening, records/customer/remediation/staged-rollout evidence, related links, and fix checklist typo. | Editorial + technical reviewer | Needs edit | Not started |
| P1 | Medium rewrite | Vulnerability Disclosure | `docs/implementation/operate-phase/vulnerability-disclosure.md` | How do we receive, triage, report, fix, evidence, and communicate vulnerabilities? | Explain public CVD, internal triage, CRA reporting, remediation, evidence, and communication responsibilities. | Add logs, customer notification, evidence, Policy Starter Kit route, and grouped related links. | Editorial + standards reviewer + product-security reviewer | Needs edit | Not started |
| P1 | Medium rewrite | Key Provisioning and Storage | `docs/implementation/build-phase/key-provisioning.md` | How should keys be created, provisioned, protected, rotated, and evidenced? | Explain the provisioning ceremony and evidence needed to avoid shared secrets and weak key handling. | Add P1 structure and stronger trust-anchor journey links. | Editorial + hardware/embedded reviewer + technical reviewer | Needs edit | Not started |
| P1 | Medium rewrite | Unique Device Identity | `docs/implementation/build-phase/unique-device-identity.md` | How does a device prove what it is across onboarding, authentication, updates, and support? | Explain product identity design and the evidence needed to prove devices are unique, authentic, and supportable. | Add P1 structure and stronger links to provisioning, crypto, OTA, hardware, and evidence. | Editorial + product-security reviewer + technical reviewer | Needs edit | Not started |
| P2 | Ready | Cryptography under the CRA | `docs/resources/cryptography/cryptography-under-cra.md` | What cryptography decisions and evidence matter under the CRA? | Help teams inventory, assess, justify, and retain evidence for cryptography decisions. | Improve routing from secure boot, OTA, provisioning, hardware, and CRA readiness pages. | Editorial + technical reviewer + standards reviewer | Done | Not started |
| P2 | Ready | Types of Embedded Device | `docs/resources/reference/types-of-embedded-device.md` | What device architecture are we dealing with and how does it affect controls and evidence? | Classify device architecture and link it to secure-by-design controls, CRA readiness, and evidence. | Improve prominence from homepage, implementation pages, hardware pages, examples, and case studies. | Editorial + hardware/embedded reviewer | Done | Not started |
| P2 | Light alignment | First Sprint Checklist | `docs/quick-start/first-sprint-checklist.md` | What should we do in the first sprint? | Give teams a practical first sprint path for secure-by-design work. | Add to working map and route from What is Secure-by-Design and homepage. | Editorial + product-security reviewer | Needs edit | Not started |
| P2 | Light alignment | How to Use Handbook | `docs/quick-start/how-to-use-handbook.md` | Which handbook path should I follow for my role? | Route readers by role, task, and likely next action. | Use to support homepage journeys. | Editorial | Needs edit | Not started |
| P2 | Medium rewrite | SBOM & VEX | `docs/implementation/build-phase/sbom-vex.md` | How do SBOM and VEX support release and vulnerability evidence? | Explain how SBOM/VEX support product development, release, and vulnerability handling evidence. | Assess against P1/P2 structure and route from Gap Analysis and Evidence Pack. | Editorial + technical reviewer + product-security reviewer | Needs rewrite | Not started |
| P2 | Medium rewrite | Threat Modeling | `docs/implementation/build-phase/threat-modeling.md` | How do we identify and evidence product security risks? | Explain how threat modeling produces risk decisions, mitigations, and evidence. | Assess against P2 entry structure and route from SbD, Types, examples, and Evidence Pack. | Editorial + product-security reviewer | Needs rewrite | Not started |
| P2 | Medium rewrite | Patch Cadence and Rollback Strategy | `docs/implementation/operate-phase/patch-cadence.md` | How do we plan update timing, rollback, and remediation expectations? | Explain update timing, rollback strategy, remediation expectations, and support-period evidence. | Align with OTA and Vulnerability Disclosure. | Editorial + technical reviewer + product-security reviewer | Needs rewrite | Not started |
| P2 | Light alignment | ETSI EN 304 623 Boot Managers | `docs/standards/eu/cra/en-304-623-boot-managers.md` | What does the boot-manager draft imply for secure boot, updates, and evidence? | Translate the draft boot-manager standard into design planning, gap analysis, and evidence considerations. | Improve inbound routing from Secure Boot, OTA, hardware, and CRA pages. | Editorial + standards reviewer + technical reviewer | Done | Not started |
| P2 | Ready | Resources hub | `docs/resources/index.md` | I know the job I need to do, but not which resource to use. | Route users by task into checklists, evidence, examples, case studies, hardware, crypto, and reference pages. | Maintain task-routing; standardise Evidence Pack naming. | Editorial | Done | In progress |
| P2 | Ready | Secure-by-Design Maturity Model | `docs/resources/checklists-and-worksheets/maturity-model.md` | How mature are our secure-by-design capabilities? | Help teams assess organisational capability and turn gaps into a roadmap. | Maintain and route from SbD and Evidence Pack. | Editorial + product-security reviewer | Done | Not started |
| P2 | Ready | Policy Starter Kit | `docs/resources/policy-and-evidence/policy-templates.md` | What policies and procedures should we publish or retain? | Provide public policy templates, internal procedure outlines, and retained evidence guidance. | Maintain and route from CVD and Evidence Pack. | Editorial + standards reviewer | Done | Not started |
| P2 | Ready | STM32 hardware page | `docs/resources/hardware/stm32.md` | How can STM32 hardware support a CRA-scoped security case? | Help teams assess STM32 security capabilities, caveats, and evidence needs. | Make opening as explicit as ESP32; improve routing. | Editorial + hardware/embedded reviewer | Needs edit | Not started |
| P2 | Ready | ESP32 hardware page | `docs/resources/hardware/espressif.md` | How can ESP32 hardware support a CRA-scoped security case? | Help teams assess ESP32 security capabilities, caveats, and evidence needs. | Maintain caveats and routing. | Editorial + hardware/embedded reviewer | Done | Not started |
| P3 | Light alignment | Real-world vulnerabilities hub | Future page under `docs/resources/real-world-vulnerabilities/` | Which real failures map to which secure-by-design controls? | Route from real failures to failure patterns, controls, evidence, and product-team checks. | Plan hub by failure pattern; do not duplicate individual cases. | Editorial + product-security reviewer | Not started | Not started |
| P3 | Ready | Threat-model examples | `docs/resources/example-documents/` | What does a proportionate threat model look like? | Show concrete, reusable examples of proportionate product threat models. | Route from Threat Modeling, Types, Gap Analysis, and Evidence Pack. | Editorial + product-security reviewer | Done | Not started |
...
- Fix existing typo `theexecutive` during the rewrite.
...
| Current problem | Page is strong, but inbound anchor text still sometimes says "Audit Evidence Pack". |
