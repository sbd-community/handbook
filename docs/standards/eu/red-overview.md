...
| **Simple Bluetooth Speaker** | Radio Equipment | ❌ No | Does not connect to the internet (directly or indirectly) and does not process personal data beyond streaming audio. |
